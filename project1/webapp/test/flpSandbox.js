		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ibmfinarproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ibmfinarproject1-display": {
								"semanticObject": "ibmfinarproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ibm.fin.ar.project1",
									"url": sap.ui.require.toUrl("ibm/fin/ar/project1")
								}
							}
						}
					}
